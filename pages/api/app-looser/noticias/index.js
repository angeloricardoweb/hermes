...
export default async function handler(req, res) {
  ...
  const data = {
    ...
    results: [
      ...
      {
        id: 4,
        titulo: '5 lugares para viaja com a família',
        img: 'https://images.unsplash.com/photo-1475503572774-15a45e5d60b9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
        dia: '02-05',
      },
    ],
  };
